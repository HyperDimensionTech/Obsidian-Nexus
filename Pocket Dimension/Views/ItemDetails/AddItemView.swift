...
struct AddItemView: View {
    ...
    private func createInventoryItem(from book: GoogleBook) -> InventoryItem {
        ...
        // Process the thumbnail URL with enhanced processing
        let thumbnailURL = processImageURL(book.volumeInfo.imageLinks?.thumbnail)
        ...
        Button(action: {
            ...
            HStack(alignment: .top, spacing: 12) {
                ...
                if let thumbnailURLString = book.volumeInfo.imageLinks?.thumbnail {
                    AsyncImage(url: processImageURL(thumbnailURLString)) { phase in
